# Generated by Django 3.0.2 on 2020-06-24 15:47
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_dt', models.DateTimeField(auto_now_add=True, verbose_name='수집시점')),
                ('pm_1_0', models.IntegerField(verbose_name='PM 1.0')),
                ('pm_2_5', models.IntegerField(verbose_name='PM 2.5')),
                ('pm_10_0', models.IntegerField(verbose_name='PM 10.0')),
            ],
            options={
                'ordering': ('create_dt',),
            },
        ...
        migrations.AlterField(
            ...
            name='man_company',
            field=models.CharField(choices=[('서돌전자통신', '서돌전자통신'), ('코스텍', '코스텍'), ('세인시스템', '세인시스템'), ('엘케이일레븐', '엘케이일레븐'), ('한국전기교통', '한국전기교통'), ('진우산전', '진우산전'), ('(주)신호', '(주)신호'), ('진우전자', '진우전자'), ('양광', '양광'), ('옵토피아', '옵토피아'), ('포에프', '포에프'), ('태경', '태경'), ('고엽제', '고엽제'), ('대한신호', '대한신호'), ('태림전자', '태림전자'), ('샤이니테크', '샤이니테크'), ('한진이엔씨', '한진이엔씨'), ('한길에이치씨', '한길에이치씨'), ('에스에이텍', '에스에이텍'), ('명신엔지니어링', '명신엔지니어링'), ('우리시스템', '우리시스템'), ('삼성SDS', '삼성SDS'), ('대진ENC', '대진ENC'), ('대진TNS', '대진TNS'), ('태은', '태은'), ('위훈용사복지회', '위훈용사복지회'), ('기타', '기타')], max_length=64, verbose_name='제조사'),
        ),
        migrations.AlterField(
            model_name='intersection',
            name='model_name',
